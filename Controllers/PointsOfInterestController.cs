...
{   
    ...
    public class PointsOfInterestController : Controller
    {
        ...
        public IActionResult UpdatePointOfInterest(int cityId, int id, [FromBody] PointsOfInterestForUpdate pointOfInterest)
        {
            if (pointOfInterest == null)
            {
                return BadRequest();
        ...
        public IActionResult PartiallyUpdatePointOfInterest(int cityId, int id, [FromBody] JsonPatchDocument<PointsOfInterestForUpdate> patchDoc)
        {
            if (!_cityInfoRepository.CityExists(cityId))
            {
                return NotFound();
            ...
            var pointOfInterestToPatch = Mapper.Map<PointsOfInterestForUpdate>(pointOfInterestEntity);
